...
if (pinInput.pin === myPin) {
    ...
    if (actionAns.options === "Withdraw Cash") {
        ...
        if (amount.cash <= mybal) {
            mybal -= amount.cash;
            console.log(`Cash Withdrawn Successfully, Your Remaining Balance is ${mybal}`);
        }
        else {
            console.log(`Dear Customer, You Have Insufficient Balance.\nYou Have ${mybal} In Your Account.`);
        }
    }
        ...
        if (fastAction.CashOptions > mybal) {
            console.log(`You Have Insufficient Amount In Your Account.\nYou Have ${mybal} In Your Account.`);
        }
        else if (fastAction.CashOptions === 5000) {
            mybal -= 5000;
            console.log(`You Have Successfully Withdrawn 5000.\nNow, You Have ${mybal} In Your Account.`);
        }
        else if (fastAction.CashOptions === 10000) {
            mybal -= 10000;
            console.log(`You Have Successfully Withdrawn 10000.\nNow, You Have ${mybal} In Your Account.`);
        }
        else if (fastAction.CashOptions === 15000) {
            mybal -= 15000;
            console.log(`You Have Successfully Withdrawn 15000.\nNow, You Have ${mybal} In Your Account.`);
        }
        else if (fastAction.CashOptions === 50000) {
            mybal -= 50000;
            console.log(`You Have Successfully Withdrawn 50000.\nNow, You Have ${mybal} In Your Account.`);
        }
        else if (fastAction.CashOptions === 200000) {
            mybal -= 200000;
            console.log(`You Have Successfully Withdrawn 200000.\nNow, You Have ${mybal} In Your Account.`);
        }
    }
